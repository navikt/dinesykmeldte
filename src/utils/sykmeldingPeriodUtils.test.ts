...
describe("getSykmeldingPeriodDescription", () => {
  it("Avventende periode", () => {
    ...
    expect(getSykmeldingPeriodDescription(period)).toBe(
      "Avventende sykmelding i 3 dager",
    );
  });
  ...
  it("1 behandlingsdag periode", () => {
    ...
    expect(getSykmeldingPeriodDescription(period)).toBe(
      "1 behandlingsdag i løpet av 3 dager",
    );
  });
  ...
  it("Flere behandlingsdager periode", () => {
    ...
    expect(getSykmeldingPeriodDescription(period)).toBe(
      "2 behandlingsdager i løpet av 3 dager",
    );
  });
});
...
describe("formatPeriodsRelative", () => {
  ...
  describe("getReadableLength", () => {
    ...
    it('should return "1 behandlingsdag i løpet av 1 dager"', () => {
      ...
      expect(getReadableLength(period)).toBe(
        "1 behandlingsdag i løpet av 1 dag",
      );
    });
    ...
    it('should return "3 behandlingsdager i løpet av 10 dager"', () => {
      ...
      expect(getReadableLength(period)).toBe(
        "3 behandlingsdager i løpet av 10 dager",
      );
    });
  });
});

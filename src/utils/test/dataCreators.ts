...
export function createDialogmote(
  overrides?: Partial<DialogmoteFragment>,
): DialogmoteFragment {
  return {
...
export function createOppfolgingsplan(
  overrides?: Partial<OppfolgingsplanFragment>,
): OppfolgingsplanFragment {
  return {
...
export function createSoknad(
  overrides?: Partial<SoknadFragment>,
): SoknadFragment {
  return {
    __typename: "Soknad",
    id: "soknad-id",
...
export function createPreviewSykmeldt(
  overrides?: Partial<PreviewSykmeldtFragment>,
): PreviewSykmeldtFragment {
  return {
...
>(mockedResponse: {
  ...
  result?:
    | FetchResult<Unmasked<Query>>
    | ResultFunction<FetchResult<Unmasked<Query>>, Record<string, unknown>>;
  error?: Error;
  delay?: number;

...
describe("SykmeldtPeriodStatus", () => {
  ...
  it("should format correctly for past period", async () => {
    const sykmeldt = createPreviewSykmeldt({
      ...
      sykmeldinger: [
        createSykmelding({
          id: sykmeldingPast.id,
          lest: true,
          perioder: sykmeldingPast.perioder,
        }),
      ],
    });
  ...
  it("should format correctly for future period", async () => {
    const sykmeldt = createPreviewSykmeldt({
      ...
      sykmeldinger: [
        createSykmelding({
          id: sykmeldingFuture.id,
          lest: true,
          perioder: sykmeldingFuture.perioder,
        }),
      ],
    });
    ...
    const sykmeldt = createPreviewSykmeldt({
      ...
      sykmeldinger: [
        createSykmelding({
          id: sykmeldingNow.id,
          lest: true,
          perioder: sykmeldingNow.perioder,
        }),
      ],
    });
  ...
  it("should format correctly for near future period", async () => {
    const sykmeldt = createPreviewSykmeldt({
      ...
      sykmeldinger: [
        ...
        createSykmelding({
          id: sykmeldingNearFuture.id,
          lest: true,
          perioder: sykmeldingNearFuture.perioder,
        }),
        createSykmelding({
          id: sykmeldingFuture.id,
          lest: true,

...
function NarmestelederInfo(): ReactElement {
  ...
  const infoPagesExpanded = useSelector(
    (state: RootState) => state.expanded.infoPagesExpanded,
  );
  return (
    <>
      <ExpansionCard
      ...
      >
        ...
        <p>
          ...
          <a href={`${browserEnv.cdnPublicPath}/videos/naermesteleder.mp4`}>
      ...
      <div className="mt-16">
        <TilbakeLink
          text="Tilbake til arbeidsgiversiden"

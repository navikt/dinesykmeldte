...
export const SoknadSporsmalSchema: z.ZodSchema<SoknadSporsmal> = z.lazy(() =>
  z.object({
    ...
    kriterieForVisningAvUndersporsmal: z
      .nativeEnum(SoknadSporsmalKriterierEnum)
      .nullable(),
...
export type PreviewFremtidigSoknadApi = z.infer<
  typeof PreviewFremtidigSoknadSchema
>;

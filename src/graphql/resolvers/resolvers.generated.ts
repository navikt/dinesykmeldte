...
export type ResolversTypes = ResolversObject<{
  ...
  BasePreviewSoknad: ResolverTypeWrapper<
    ResolversInterfaceTypes<ResolversTypes>["BasePreviewSoknad"]
  >;
  ...
  FomTom: ResolverTypeWrapper<
    ResolversInterfaceTypes<ResolversTypes>["FomTom"]
  >;
  ...
  PreviewSoknad: ResolverTypeWrapper<
    ResolversUnionTypes<ResolversTypes>["PreviewSoknad"]
  >;
...
export type AktivitetIkkeMuligResolvers<
  ...
  ParentType extends
    ResolversParentTypes["AktivitetIkkeMulig"] = ResolversParentTypes["AktivitetIkkeMulig"],
> = ResolversObject<{
  arbeidsrelatertArsak?: Resolver<
    Maybe<ResolversTypes["ArbeidsrelatertArsak"]>,
    ParentType,
    ContextType
  >;
...
export type ArbeidsgiverResolvers<
  ContextType = ResolverContextType,
  ParentType extends
    ResolversParentTypes["Arbeidsgiver"] = ResolversParentTypes["Arbeidsgiver"],
> = ResolversObject<{
...
export type ArbeidsrelatertArsakResolvers<
  ContextType = ResolverContextType,
  ParentType extends
    ResolversParentTypes["ArbeidsrelatertArsak"] = ResolversParentTypes["ArbeidsrelatertArsak"],
> = ResolversObject<{
  arsak?: Resolver<
    Array<ResolversTypes["ArbeidsrelatertArsakEnum"]>,
    ParentType,
    ContextType
  >;
  beskrivelse?: Resolver<
...
export type AvventendeResolvers<
  ContextType = ResolverContextType,
  ParentType extends
    ResolversParentTypes["Avventende"] = ResolversParentTypes["Avventende"],
> = ResolversObject<{
  fom?: Resolver<ResolversTypes["Date"], ParentType, ContextType>;
  tilrettelegging?: Resolver<
    Maybe<ResolversTypes["String"]>,
    ParentType,
    ContextType
  >;
...
export type BasePreviewSoknadResolvers<
  ContextType = ResolverContextType,
  ParentType extends
    ResolversParentTypes["BasePreviewSoknad"] = ResolversParentTypes["BasePreviewSoknad"],
> = ResolversObject<{
  ...
  perioder?: Resolver<
    Array<ResolversTypes["Soknadsperiode"]>,
    ParentType,
    ContextType
  >;
  status?: Resolver<
    ResolversTypes["SoknadsstatusEnum"],
    ParentType,
    ContextType
  >;
...
export type BehandlerResolvers<
  ContextType = ResolverContextType,
  ParentType extends
    ResolversParentTypes["Behandler"] = ResolversParentTypes["Behandler"],
> = ResolversObject<{
  hprNummer?: Resolver<
    Maybe<ResolversTypes["String"]>,
    ParentType,
...
export type BehandlingsdagerResolvers<
  ContextType = ResolverContextType,
  ParentType extends
    ResolversParentTypes["Behandlingsdager"] = ResolversParentTypes["Behandlingsdager"],
> = ResolversObject<{
...
export type DialogmoteResolvers<
  ContextType = ResolverContextType,
  ParentType extends
    ResolversParentTypes["Dialogmote"] = ResolversParentTypes["Dialogmote"],
> = ResolversObject<{
...
export type FomTomResolvers<
  ContextType = ResolverContextType,
  ParentType extends
    ResolversParentTypes["FomTom"] = ResolversParentTypes["FomTom"],
> = ResolversObject<{
  __resolveType: TypeResolveFn<
    | "AktivitetIkkeMulig"
    | "Avventende"
...
export type GradertResolvers<
  ContextType = ResolverContextType,
  ParentType extends
    ResolversParentTypes["Gradert"] = ResolversParentTypes["Gradert"],
> = ResolversObject<{
  fom?: Resolver<ResolversTypes["Date"], ParentType, ContextType>;
...
export type OppfolgingsplanResolvers<
  ContextType = ResolverContextType,
  ParentType extends
    ResolversParentTypes["Oppfolgingsplan"] = ResolversParentTypes["Oppfolgingsplan"],
> = ResolversObject<{
  hendelseId?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
  mottatt?: Resolver<ResolversTypes["DateTime"], ParentType, ContextType>;
  tekst?: Resolver<Maybe<ResolversTypes["String"]>, ParentType, ContextType>;
...
export type PeriodeResolvers<
  ContextType = ResolverContextType,
  ParentType extends
    ResolversParentTypes["Periode"] = ResolversParentTypes["Periode"],
> = ResolversObject<{
  __resolveType: TypeResolveFn<
    | "AktivitetIkkeMulig"
    | "Avventende"
...
export type PreviewFremtidigSoknadResolvers<
  ContextType = ResolverContextType,
  ParentType extends
    ResolversParentTypes["PreviewFremtidigSoknad"] = ResolversParentTypes["PreviewFremtidigSoknad"],
> = ResolversObject<{
  fom?: Resolver<ResolversTypes["Date"], ParentType, ContextType>;
  id?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
  perioder?: Resolver<
...
export type PreviewNySoknadResolvers<
  ContextType = ResolverContextType,
  ParentType extends
    ResolversParentTypes["PreviewNySoknad"] = ResolversParentTypes["PreviewNySoknad"],
> = ResolversObject<{
  fom?: Resolver<ResolversTypes["Date"], ParentType, ContextType>;
  id?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
  ikkeSendtSoknadVarsel?: Resolver<
    ResolversTypes["Boolean"],
    ParentType,
    ContextType
  >;
  ikkeSendtSoknadVarsletDato?: Resolver<
...
export type PreviewSendtSoknadResolvers<
  ContextType = ResolverContextType,
  ParentType extends
    ResolversParentTypes["PreviewSendtSoknad"] = ResolversParentTypes["PreviewSendtSoknad"],
> = ResolversObject<{
  fom?: Resolver<ResolversTypes["Date"], ParentType, ContextType>;
  id?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
  korrigererSoknadId?: Resolver<
    Maybe<ResolversTypes["String"]>,
    ParentType,
    ContextType
  >;
...
export type PreviewSoknadResolvers<
  ContextType = ResolverContextType,
  ParentType extends
    ResolversParentTypes["PreviewSoknad"] = ResolversParentTypes["PreviewSoknad"],
> = ResolversObject<{
  __resolveType: TypeResolveFn<
    "PreviewFremtidigSoknad" | "PreviewNySoknad" | "PreviewSendtSoknad",
    ParentType,
...
> = ResolversObject<{
  ...
  navn?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
  oppfolgingsplaner?: Resolver<
    Array<ResolversTypes["Oppfolgingsplan"]>,
    ParentType,
    ContextType
  >;
...
> = ResolversObject<{
  mineSykmeldte?: Resolver<
    Maybe<Array<ResolversTypes["PreviewSykmeldt"]>>,
    ParentType,
    ContextType
  >;
  soknad?: Resolver<
  ...
  >;
  virksomheter?: Resolver<
    Array<ResolversTypes["Virksomhet"]>,
    ParentType,
    ContextType
  >;
}>;
...
export type ReisetilskuddResolvers<
  ContextType = ResolverContextType,
  ParentType extends
    ResolversParentTypes["Reisetilskudd"] = ResolversParentTypes["Reisetilskudd"],
> = ResolversObject<{
  fom?: Resolver<ResolversTypes["Date"], ParentType, ContextType>;
  tom?: Resolver<ResolversTypes["Date"], ParentType, ContextType>;
  type?: Resolver<ResolversTypes["PeriodeEnum"], ParentType, ContextType>;
...
export type SoknadResolvers<
  ContextType = ResolverContextType,
  ParentType extends
    ResolversParentTypes["Soknad"] = ResolversParentTypes["Soknad"],
> = ResolversObject<{
  fnr?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
  fom?: Resolver<ResolversTypes["Date"], ParentType, ContextType>;
  ...
  >;
  sendtDato?: Resolver<ResolversTypes["DateTime"], ParentType, ContextType>;
  sendtTilNavDato?: Resolver<
    Maybe<ResolversTypes["DateTime"]>,
    ParentType,
    ContextType
  >;
  sporsmal?: Resolver<
    Array<ResolversTypes["SoknadSporsmal"]>,
    ParentType,
    ContextType
  >;
  sykmeldingId?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
...
export type SoknadSporsmalResolvers<
  ContextType = ResolverContextType,
  ParentType extends
    ResolversParentTypes["SoknadSporsmal"] = ResolversParentTypes["SoknadSporsmal"],
> = ResolversObject<{
  id?: Resolver<ResolversTypes["UUID"], ParentType, ContextType>;
  ...
  sporsmalstekst?: Resolver<
    Maybe<ResolversTypes["String"]>,
    ParentType,
    ContextType
  >;
  svar?: Resolver<
    Maybe<Array<Maybe<ResolversTypes["SoknadSporsmalSvar"]>>>,
    ParentType,
    ContextType
  >;
  svartype?: Resolver<
    ResolversTypes["SoknadSporsmalSvartypeEnum"],
    ParentType,
    ContextType
  >;
  tag?: Resolver<ResolversTypes["SporsmalTagEnum"], ParentType, ContextType>;
  undersporsmal?: Resolver<
    Maybe<Array<Maybe<ResolversTypes["SoknadSporsmal"]>>>,
    ParentType,
    ContextType
  >;
  undertekst?: Resolver<
...
export type SoknadSporsmalSvarResolvers<
  ContextType = ResolverContextType,
  ParentType extends
    ResolversParentTypes["SoknadSporsmalSvar"] = ResolversParentTypes["SoknadSporsmalSvar"],
> = ResolversObject<{
...
export type SoknadsperiodeResolvers<
  ContextType = ResolverContextType,
  ParentType extends
    ResolversParentTypes["Soknadsperiode"] = ResolversParentTypes["Soknadsperiode"],
> = ResolversObject<{
  fom?: Resolver<ResolversTypes["Date"], ParentType, ContextType>;
  sykmeldingsgrad?: Resolver<
    Maybe<ResolversTypes["Int"]>,
    ParentType,
    ContextType
  >;
  sykmeldingstype?: Resolver<
    ResolversTypes["PeriodeEnum"],
    ParentType,
    ContextType
  >;
  tom?: Resolver<ResolversTypes["Date"], ParentType, ContextType>;
...
export type SykmeldingResolvers<
  ContextType = ResolverContextType,
  ParentType extends
    ResolversParentTypes["Sykmelding"] = ResolversParentTypes["Sykmelding"],
> = ResolversObject<{
  arbeidsforEtterPeriode?: Resolver<
    Maybe<ResolversTypes["Boolean"]>,
    ParentType,
    ContextType
  >;
  arbeidsgiver?: Resolver<
    ResolversTypes["Arbeidsgiver"],
    ParentType,
    ContextType
  >;
  behandler?: Resolver<
    Maybe<ResolversTypes["Behandler"]>,
    ParentType,
    ContextType
  >;
  behandletTidspunkt?: Resolver<
    ResolversTypes["Date"],
    ParentType,
    ContextType
  >;
  egenmeldingsdager?: Resolver<
    Maybe<Array<ResolversTypes["Date"]>>,
    ParentType,
    ContextType
  >;
  fnr?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
  hensynArbeidsplassen?: Resolver<
    Maybe<ResolversTypes["String"]>,
    ParentType,
    ContextType
  >;
  id?: Resolver<ResolversTypes["UUID"], ParentType, ContextType>;
  innspillArbeidsplassen?: Resolver<
    Maybe<ResolversTypes["String"]>,
    ParentType,
    ContextType
  >;
  kontaktDato?: Resolver<
  ...
  navn?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
  perioder?: Resolver<
    Array<ResolversTypes["Periode"]>,
    ParentType,
    ContextType
  >;
  sendtTilArbeidsgiverDato?: Resolver<
    Maybe<ResolversTypes["DateTime"]>,
    ParentType,
    ContextType
  >;
  tiltakArbeidsplassen?: Resolver<
    Maybe<ResolversTypes["String"]>,
    ParentType,
    ContextType
  >;
  utenlandskSykmelding?: Resolver<
    Maybe<ResolversTypes["UtenlandskSykmelding"]>,
    ParentType,
    ContextType
  >;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type UtenlandskSykmeldingResolvers<
  ContextType = ResolverContextType,
  ParentType extends
    ResolversParentTypes["UtenlandskSykmelding"] = ResolversParentTypes["UtenlandskSykmelding"],
> = ResolversObject<{
...
export type VirksomhetResolvers<
  ContextType = ResolverContextType,
  ParentType extends
    ResolversParentTypes["Virksomhet"] = ResolversParentTypes["Virksomhet"],
> = ResolversObject<{
  navn?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
  orgnummer?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;

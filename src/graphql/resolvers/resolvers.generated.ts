...
export type ResolversTypes = ResolversObject<{
  ...
  PreviewSykmeldt: ResolverTypeWrapper<Omit<PreviewSykmeldt, 'previewSoknader' | 'sykmeldinger'> & { previewSoknader: Array<ResolversTypes['PreviewSoknad']>, sykmeldinger: Array<ResolversTypes['Sykmelding']> }>;
  ...
  Sykmelding: ResolverTypeWrapper<Omit<Sykmelding, 'arbeidsgiver' | 'perioder'> & { arbeidsgiver: ResolversTypes['Arbeidsgiver'], perioder: Array<ResolversTypes['Periode']> }>;
...
export type ResolversParentTypes = ResolversObject<{
  ...
  PreviewSykmeldt: Omit<PreviewSykmeldt, 'previewSoknader' | 'sykmeldinger'> & { previewSoknader: Array<ResolversParentTypes['PreviewSoknad']>, sykmeldinger: Array<ResolversParentTypes['Sykmelding']> };
  Query: {};
  Reisetilskudd: Reisetilskudd;
  Soknad: Soknad;
  ...
  Sykmelding: Omit<Sykmelding, 'arbeidsgiver' | 'perioder'> & { arbeidsgiver: ResolversParentTypes['Arbeidsgiver'], perioder: Array<ResolversParentTypes['Periode']> };
  UUID: Scalars['UUID']['output'];
  UtenlandskSykmelding: UtenlandskSykmelding;
  Virksomhet: Virksomhet;
}>;

export type AktivitetIkkeMuligResolvers<ContextType = ResolverContextType, ParentType extends ResolversParentTypes['AktivitetIkkeMulig'] = ResolversParentTypes['AktivitetIkkeMulig']> = ResolversObject<{
...
export type AktivitetsvarselResolvers<ContextType = ResolverContextType, ParentType extends ResolversParentTypes['Aktivitetsvarsel'] = ResolversParentTypes['Aktivitetsvarsel']> = ResolversObject<{
...
export type ArbeidsgiverResolvers<ContextType = ResolverContextType, ParentType extends ResolversParentTypes['Arbeidsgiver'] = ResolversParentTypes['Arbeidsgiver']> = ResolversObject<{
  navn?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type ArbeidsrelatertArsakResolvers<ContextType = ResolverContextType, ParentType extends ResolversParentTypes['ArbeidsrelatertArsak'] = ResolversParentTypes['ArbeidsrelatertArsak']> = ResolversObject<{
...
export type AvventendeResolvers<ContextType = ResolverContextType, ParentType extends ResolversParentTypes['Avventende'] = ResolversParentTypes['Avventende']> = ResolversObject<{
  fom?: Resolver<ResolversTypes['Date'], ParentType, ContextType>;
...
export type BasePreviewSoknadResolvers<ContextType = ResolverContextType, ParentType extends ResolversParentTypes['BasePreviewSoknad'] = ResolversParentTypes['BasePreviewSoknad']> = ResolversObject<{
  __resolveType: TypeResolveFn<'PreviewFremtidigSoknad' | 'PreviewNySoknad' | 'PreviewSendtSoknad', ParentType, ContextType>;
  fom?: Resolver<ResolversTypes['Date'], ParentType, ContextType>;
...
export type BehandlerResolvers<ContextType = ResolverContextType, ParentType extends ResolversParentTypes['Behandler'] = ResolversParentTypes['Behandler']> = ResolversObject<{
...
export type BehandlingsdagerResolvers<ContextType = ResolverContextType, ParentType extends ResolversParentTypes['Behandlingsdager'] = ResolversParentTypes['Behandlingsdager']> = ResolversObject<{
...
export type DialogmoteResolvers<ContextType = ResolverContextType, ParentType extends ResolversParentTypes['Dialogmote'] = ResolversParentTypes['Dialogmote']> = ResolversObject<{
...
export type FomTomResolvers<ContextType = ResolverContextType, ParentType extends ResolversParentTypes['FomTom'] = ResolversParentTypes['FomTom']> = ResolversObject<{
  __resolveType: TypeResolveFn<'AktivitetIkkeMulig' | 'Avventende' | 'Behandlingsdager' | 'Gradert' | 'Reisetilskudd' | 'Soknadsperiode', ParentType, ContextType>;
  fom?: Resolver<ResolversTypes['Date'], ParentType, ContextType>;
  tom?: Resolver<ResolversTypes['Date'], ParentType, ContextType>;
}>;

export type GradertResolvers<ContextType = ResolverContextType, ParentType extends ResolversParentTypes['Gradert'] = ResolversParentTypes['Gradert']> = ResolversObject<{
  fom?: Resolver<ResolversTypes['Date'], ParentType, ContextType>;
...
export type MutationResolvers<ContextType = ResolverContextType, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = ResolversObject<{
  markAktivitetvarselRead?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType, RequireFields<MutationMarkAktivitetvarselReadArgs, 'sykmeldtId'>>;
  markAllSykmeldingerAndSoknaderAsRead?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType>;
  read?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType, RequireFields<MutationReadArgs, 'id' | 'type'>>;
  unlinkSykmeldt?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType, RequireFields<MutationUnlinkSykmeldtArgs, 'sykmeldtId'>>;
}>;

export type OppfolgingsplanResolvers<ContextType = ResolverContextType, ParentType extends ResolversParentTypes['Oppfolgingsplan'] = ResolversParentTypes['Oppfolgingsplan']> = ResolversObject<{
  hendelseId?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  mottatt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  tekst?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type PeriodeResolvers<ContextType = ResolverContextType, ParentType extends ResolversParentTypes['Periode'] = ResolversParentTypes['Periode']> = ResolversObject<{
  __resolveType: TypeResolveFn<'AktivitetIkkeMulig' | 'Avventende' | 'Behandlingsdager' | 'Gradert' | 'Reisetilskudd', ParentType, ContextType>;
}>;

export type PreviewFremtidigSoknadResolvers<ContextType = ResolverContextType, ParentType extends ResolversParentTypes['PreviewFremtidigSoknad'] = ResolversParentTypes['PreviewFremtidigSoknad']> = ResolversObject<{
  fom?: Resolver<ResolversTypes['Date'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  perioder?: Resolver<Array<ResolversTypes['Soknadsperiode']>, ParentType, ContextType>;
  status?: Resolver<ResolversTypes['SoknadsstatusEnum'], ParentType, ContextType>;
...
export type PreviewNySoknadResolvers<ContextType = ResolverContextType, ParentType extends ResolversParentTypes['PreviewNySoknad'] = ResolversParentTypes['PreviewNySoknad']> = ResolversObject<{
  fom?: Resolver<ResolversTypes['Date'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
export type PreviewSendtSoknadResolvers<ContextType = ResolverContextType, ParentType extends ResolversParentTypes['PreviewSendtSoknad'] = ResolversParentTypes['PreviewSendtSoknad']> = ResolversObject<{
  fom?: Resolver<ResolversTypes['Date'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
export type PreviewSoknadResolvers<ContextType = ResolverContextType, ParentType extends ResolversParentTypes['PreviewSoknad'] = ResolversParentTypes['PreviewSoknad']> = ResolversObject<{
  __resolveType: TypeResolveFn<'PreviewFremtidigSoknad' | 'PreviewNySoknad' | 'PreviewSendtSoknad', ParentType, ContextType>;
}>;

export type PreviewSykmeldtResolvers<ContextType = ResolverContextType, ParentType extends ResolversParentTypes['PreviewSykmeldt'] = ResolversParentTypes['PreviewSykmeldt']> = ResolversObject<{
...
export type QueryResolvers<ContextType = ResolverContextType, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = ResolversObject<{
  mineSykmeldte?: Resolver<Maybe<Array<ResolversTypes['PreviewSykmeldt']>>, ParentType, ContextType>;
  soknad?: Resolver<Maybe<ResolversTypes['Soknad']>, ParentType, ContextType, RequireFields<QuerySoknadArgs, 'soknadId'>>;
  sykmelding?: Resolver<Maybe<ResolversTypes['Sykmelding']>, ParentType, ContextType, RequireFields<QuerySykmeldingArgs, 'sykmeldingId'>>;
  virksomheter?: Resolver<Array<ResolversTypes['Virksomhet']>, ParentType, ContextType>;
}>;

export type ReisetilskuddResolvers<ContextType = ResolverContextType, ParentType extends ResolversParentTypes['Reisetilskudd'] = ResolversParentTypes['Reisetilskudd']> = ResolversObject<{
  fom?: Resolver<ResolversTypes['Date'], ParentType, ContextType>;
  tom?: Resolver<ResolversTypes['Date'], ParentType, ContextType>;
  type?: Resolver<ResolversTypes['PeriodeEnum'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type SoknadResolvers<ContextType = ResolverContextType, ParentType extends ResolversParentTypes['Soknad'] = ResolversParentTypes['Soknad']> = ResolversObject<{
  fnr?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  fom?: Resolver<ResolversTypes['Date'], ParentType, ContextType>;
...
export type SoknadSporsmalResolvers<ContextType = ResolverContextType, ParentType extends ResolversParentTypes['SoknadSporsmal'] = ResolversParentTypes['SoknadSporsmal']> = ResolversObject<{
  id?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
  kriterieForVisningAvUndersporsmal?: Resolver<Maybe<ResolversTypes['SoknadSporsmalKriterierEnum']>, ParentType, ContextType>;
...
export type SoknadSporsmalSvarResolvers<ContextType = ResolverContextType, ParentType extends ResolversParentTypes['SoknadSporsmalSvar'] = ResolversParentTypes['SoknadSporsmalSvar']> = ResolversObject<{
  verdi?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type SoknadsperiodeResolvers<ContextType = ResolverContextType, ParentType extends ResolversParentTypes['Soknadsperiode'] = ResolversParentTypes['Soknadsperiode']> = ResolversObject<{
  fom?: Resolver<ResolversTypes['Date'], ParentType, ContextType>;
...
export type SykmeldingResolvers<ContextType = ResolverContextType, ParentType extends ResolversParentTypes['Sykmelding'] = ResolversParentTypes['Sykmelding']> = ResolversObject<{
...
export type UtenlandskSykmeldingResolvers<ContextType = ResolverContextType, ParentType extends ResolversParentTypes['UtenlandskSykmelding'] = ResolversParentTypes['UtenlandskSykmelding']> = ResolversObject<{
  land?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type VirksomhetResolvers<ContextType = ResolverContextType, ParentType extends ResolversParentTypes['Virksomhet'] = ResolversParentTypes['Virksomhet']> = ResolversObject<{
  navn?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  orgnummer?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;
